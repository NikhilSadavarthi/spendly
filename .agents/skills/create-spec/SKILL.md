...
Spendly expense tracker. Always follow the rules in antigravity.md.
...
Save to: `.antigravity/specs/<step_number>-<feature_slug>.md`

## Step 9 — Report to the user
Print a short summary in this exact format:
```
Branch:    <branch_name>
Spec file: .antigravity/specs/<step_number>-<feature_slug>.md
Title:     <feature_title>
```

Then tell the user:
"Review the spec at `.antigravity/specs/<step_number>-<feature_slug>.md`
